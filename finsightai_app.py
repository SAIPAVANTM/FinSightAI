...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://saipavantm:859@10.158.67.210/finsightai'
...
Thank you for your trust, and welcome to FinSightAI!
...
def send_otp():
    try:
        ...
        # Check if email exists in userdetails table
